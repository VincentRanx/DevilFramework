...
namespace Devil
{
    public class SingletonMono<T> : MonoBehaviour where T : SingletonMono<T>
    {
...
#if UNITY_EDITOR
                RTLog.LogFormat(LogCat.Game, "Instance Singleton<{0}>.", sInstance.GetType());
#endif
            }
            return sInstance;
        }
        ...
        protected virtual void Awake()
        {
            ...
            {
#if UNITY_EDITOR
                RTLog.LogWarning(LogCat.Game, string.Format("There are more than one SingletonMono of {0}, check it first.\nWe found {1} and {2}",
