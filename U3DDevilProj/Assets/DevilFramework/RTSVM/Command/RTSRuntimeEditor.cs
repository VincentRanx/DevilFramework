...
namespace Devil.Command
{
    ...
    public class RTSRuntimeEditor : RTSUnityRuntime
    {
        ...
        public string[] m_SearchFolders = new string[] { "Assets" };

        RTSAssistant assistant;

        public bool LogScript { get; set; }
        ...
        public bool Open
        {
            ...
            set
            {
                ...
                if (old && old != _current)
                    old.Open = false;
                if(mEventSys == null)
                    mEventSys = EventSystem.current;
                if (mEventSys != null)
                    mEventSys.enabled = enableUgui || !mOpened;
            }
        }
        ...
        [RTSPlugin(Name = "editor", ArgCount = 0)]
        object editor(object[] args)
        {
            return this;
        }
        ...
        {
            bool set;
            Dictionary<string, object> dics = Ref.GetField(mEngine, "mVars", out set) as Dictionary<string, object>;
            int counter = 0;
            ...
            RTSStack stack = Ref.GetField(mThreads[pid], "mStack", out set) as RTSStack;
            while (stack != null)
            {
                dics = Ref.GetField(stack, "mVars", out set) as Dictionary<string, object>;
                if (dics != null)
                {
        ...
        object find_var(object[] args)
        {
            ...
            dics = Ref.GetField(mEngine, "mVars", out set) as Dictionary<string, object>;
        ...
        {
            string res;
            string path = LoadTextAsset(args[0].ToString(), m_SearchFolders, out res);
