...
namespace DevilTeam.Editor
{
    ...
    public class CheckWindow : EditorWindow
    {
        ...
        public class GameObjectFilter : SubPage
        {
            ...
            bool DrawResultItem(int index, int counter)
            {
                ...
                bool oldFout = EditorPrefs.GetBool("go" + index);
            ...
            void DrawResultsList()
            {
                ...
                pPercent = GUILayout.HorizontalSlider(pPercent, 0f, 1f);
        ...
        public class GUIStyleViewport : SubPage
        {
